...
class KOSPI200StyleCrawler(baseUrl : String, targetID : String, nameOfStock : String, chartType : Array<String>) {
    ...
    private fun crawlchangeValue():String {
        val str = getElements("#change_value > span")
        return str.text().split(" ")[0]
    }

    private fun crawlchangeRate():String{
        val str = getElements("#change_rate > strong").text()
        return str.split("%")[0]
    }
